...
public class NonBlockingConnectionHandler<T> implements ConnectionHandler<T> {
    ...
    public NonBlockingConnectionHandler(MessageEncoderDecoder<T> reader, BidiMessagingProtocolImpl<T> protocol, SocketChannel chan, Reactor reactor, int connectionId) {
        this.chan = chan;
        this.encdec = reader;
